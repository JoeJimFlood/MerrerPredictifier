...
matchups['Thursday Night'] = [('OAK', 'LAC')]
matchups['Sunday Morning'] = [('CIN', 'BAL'),
                              ('CLE', 'BUF'),
                              ('CHI', 'DET'),
                              ('NYJ', 'NYG'),
                              ('TEN', 'KC'),
                              ('TB', 'ARI'),
                              ('NO', 'ATL')]
matchups['Sunday Afternoon'] = [('IND', 'MIA'),
                                ('PIT', 'LAR'),
                                ('GB', 'CAR')]
matchups['Sunday Night'] = [('DAL', 'MIN')]
matchups['Monday Night'] = [('SF', 'SEA')]
