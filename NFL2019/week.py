...
matchups['Thursday Night'] = [('MIN', 'WAS')]
matchups['Sunday Morning'] = [('IND', 'DEN'),
                              ('TEN', 'TB'),
                              ('NO', 'ARI'),
                              ('LAR', 'CIN', 'LON'),
                              ('JAX', 'NYJ'),
                              ...
                              ('BUF', 'PHI'),
                              ('ATL', 'SEA')]
matchups['Sunday Afternoon'] = [('SF', 'CAR'),
                                ('NE', 'CLE'),
                                ('HOU', 'OAK')]
matchups['Sunday Night'] = [('KC', 'GB')]
matchups['Monday Night'] = [('PIT', 'MIA')]
