...
matchups['Thursday Night'] = [('BAL', 'NYJ')]
matchups['Sunday Morning'] = [('CIN', 'NE'),
                              ('DET', 'TB'),
                              ('TEN', 'HOU'),
                              ('KC', 'DEN'),
                              ('NYG', 'MIA'),
                              ...
                              ('CAR', 'SEA'),
                              ('GB', 'CHI')]
matchups['Sunday Afternoon'] = [('LAC', 'MIN'),
                                ('OAK', 'JAX'),
                                ('ARI', 'CLE'),
                                ('DAL', 'LAR'),
                                ('SF', 'ATL')]
matchups['Sunday Night'] = [('PIT', 'BUF')]
matchups['Monday Night'] = [('NO', 'IND')]
