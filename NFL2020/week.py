...
matchups['Thursday Night'] = [('NYJ', 'DEN')]
matchups['Sunday Morning'] = [('WAS', 'BAL'),
                              ('TEN', 'PIT'),
                              ('TB', 'LAC'),
                              ('MIA', 'SEA'),
                              ('HOU', 'MIN'),
                              ...
                              ('CHI', 'IND'),
                              ('CAR', 'ARI')]
matchups['Sunday Afternoon'] = [('LAR', 'NYG'),
                                ('LV', 'BUF'),
                                ('KC', 'NE')]
matchups['Sunday Night'] = [('SF', 'PHI')]
matchups['Monday Night'] = [('GB', 'ATL')]
