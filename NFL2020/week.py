...
matchups['Thursday Night'] = [('JAX', 'MIA')]
matchups['Sunday Morning'] = [('PIT', 'HOU'),
                              ('PHI', 'CIN'),
                              ('NYG', 'SF'),
                              ('NE', 'LV'),
                              ('MIN', 'TEN'),
                              ...
                              ('BUF', 'LAR'),
                              ('ATL', 'CHI')]
matchups['Sunday Afternoon'] = [('LAC', 'CAR'),
                                ('IND', 'NYJ'),
                                ('SEA', 'DAL'),
                                ('DEN', 'TB'),
                                ('ARI', 'DET')]
matchups['Sunday Night'] = [('NO', 'GB')]
matchups['Monday Night'] = [('BAL', 'KC')]
