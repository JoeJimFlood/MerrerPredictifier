...
matchups['Thursday Night'] = [('CAR', 'ATL')]
matchups['Sunday Morning'] = [('BAL', 'PIT'),
                              ('MIA', 'LAR'),
                              ('KC', 'NYJ'),
                              ('GB', 'MIN'),
                              ('DET', 'IND'),
                              ...
                              ('CIN', 'TEN'),
                              ('BUF', 'NE')]
matchups['Sunday Afternoon'] = [('DEN', 'LAC'),
                                ('SEA', 'SF'),
                                ('CHI', 'NO')]
matchups['Sunday Night'] = [('PHI', 'DAL')]
matchups['Monday Night'] = [('NYG', 'TB')]
...
colors = {}
team_formats = {}
color_df = pd.read_csv(location + '/colors.csv', index_col = 0)
...
name_map = pd.read_csv(location + '/names.csv', index_col = 0)['NAME'].to_dict()
