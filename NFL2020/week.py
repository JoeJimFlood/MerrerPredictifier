...
matchups['Thursday Night'] = [('CHI', 'TB')]
matchups['Sunday Morning'] = [('WAS', 'LAR'),
                              ('TEN', 'BUF'),
                              ('PIT', 'PHI'),
                              ('NYJ', 'ARI'),
                              ('KC', 'LV'),
                              ...
                              ('BAL', 'CIN'),
                              ('ATL', 'CAR')]
matchups['Sunday Afternoon'] = [('SF', 'MIA'),
                                ('DAL', 'NYG'),
                                ('CLE', 'IND'),
                                ('NE', 'DEN')]
matchups['Sunday Night'] = [('SEA', 'MIN')]
matchups['Monday Night'] = [('NO', 'LAC')]
