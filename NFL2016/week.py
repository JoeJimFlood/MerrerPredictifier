...
matchups['Thursday Night'] = [('MIN', 'DAL')]
matchups['Sunday Morning'] = [('ATL', 'KC'),
                              ('NO', 'DET'),
                              ('NE', 'LA'),
                              ('JAX', 'DEN'),
                              ('GB', 'HOU'),
                              ...
                              ('BAL', 'MIA'),
                              ('CHI','SF')]
matchups['Sunday Afternoon'] = [('OAK', 'BUF'),
                                ('PIT', 'NYG'),
                                ('ARI', 'WAS'),
                                ('SD', 'TB')]
matchups['Sunday Night'] = [('SEA', 'CAR')]
matchups['Monday Night'] = [('NYJ', 'IND')]
