...
matchups['Saturday Morning'] = [('BUF', 'MIA'),
                              ('NE', 'NYJ'),
                              ('JAX', 'TEN'),
                              ('GB', 'MIN'),
                              ('CLE', 'SD'),
                              ('CHI', 'WAS'),
                              ('CAR', 'ATL')]
matchups['Saturday Afternoon'] = [('OAK', 'IND'),
                                ('NO', 'TB'),
                                ('SEA', 'ARI'),
                                ('LA', 'SF')]
matchups['Saturday Night'] = [('HOU', 'CIN')]
matchups['Sunday'] = [('PIT', 'BAL'),
                      ('KC', 'DEN')]
matchups['Monday Night'] = [('DAL', 'DET')]
