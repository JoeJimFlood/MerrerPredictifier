...
matchups['Thursday Night'] = [('KC', 'LAC')]
matchups['Saturday Night'] = [('NYJ', 'HOU'),
                              ('DEN', 'CLE')]
matchups['Sunday Morning'] = [('CHI', 'GB'),
                              ...
                              ('JAX', 'WAS'),
                              ('IND', 'DAL')]
matchups['Sunday Afternoon'] = [('SF', 'SEA'),
                                ('PIT', 'NE')]
matchups['Sunday Night'] = [('LAR', 'PHI')]
matchups['Monday Night'] = [('CAR', 'NO')]
