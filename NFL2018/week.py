...
matchups['Thursday Night'] = [('SF', 'OAK')]
matchups['Sunday Morning'] = [('BUF', 'CHI'),
                              ('CAR', 'TB'),
                              ('CLE', 'KC'),
                              ('MIA', 'NYJ'),
                              ('BAL', 'PIT'),
                              ('MIN', 'DET'),
                              ('WAS', 'ATL')]
matchups['Sunday Afternoon'] = [('DEN', 'HOU'),
                                ('SEA', 'LAC'),
                                ('NO', 'LAR')]
matchups['Sunday Night'] = [('NE', 'GB')]
matchups['Monday Night'] = [('DAL', 'TEN')]
