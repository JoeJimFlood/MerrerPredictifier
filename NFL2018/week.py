...
matchups['Thanksgiving'] = [('DET', 'CHI'),
                            ('DAL', 'WAS'),
                            ('NO', 'ATL')]
matchups['Sunday Morning'] = [('CIN', 'CLE'),
                              ('TB', 'SF'),
                              ('BUF', 'JAX'),
                              ('BAL', 'OAK'),
                              ('CAR', 'SEA'),
                              ('NYJ', 'NE'),
                              ('PHI', 'NYG')]
matchups['Sunday Afternoon'] = [('LAC', 'ARI'),
                                ('IND', 'MIA'),
                                ('DEN', 'PIT')]
matchups['Sunday Night'] = [('MIN', 'GB')]
matchups['Monday Night'] = [('HOU', 'TEN')]
