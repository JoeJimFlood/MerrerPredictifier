...
matchups['Thursday Night'] = [('DAL', 'NO')]
matchups['Sunday Morning'] = [('BAL', 'ATL'),
                              ('TB', 'CAR'),
                              ('NYG', 'CHI'),
                              ('MIA', 'BUF'),
                              ('JAX', 'IND'),
                              ...
                              ('DET', 'LAR'),
                              ('GB', 'ARI')]
matchups['Sunday Afternoon'] = [('OAK', 'KC'),
                                ('TEN', 'NYJ'),
                                ('SEA', 'SF'),
                                ('NE', 'MIN')]
matchups['Sunday Night'] = [('PIT', 'LAC')]
matchups['Monday Night'] = [('PHI', 'WAS')]
